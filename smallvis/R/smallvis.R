...
smallvis <- function(X, k = 2, scale = "absmax", 
  ...
  if (is.character(method)) {
    ...
    cost_fn <- switch(method,
         tsne = tsne(perplexity = perplexity, n_threads = n_threads, eps = eps, use_cpp = use_cpp),
         umap = umap(perplexity = perplexity, n_threads = n_threads, eps = eps, use_cpp = use_cpp),
         largevis = largevis(perplexity = perplexity, n_threads = n_threads, eps = eps, use_cpp = use_cpp),
         tumap = tumap(perplexity = perplexity, n_threads = n_threads, eps = eps, use_cpp = use_cpp),
         ntumap = ntumap(perplexity = perplexity, n_threads = n_threads, eps = eps, use_cpp = use_cpp),
         ...
         asne = asne(perplexity = perplexity, n_threads = n_threads, eps = eps, use_cpp = use_cpp),
         ssne = ssne(perplexity = perplexity, n_threads = n_threads, eps = eps, use_cpp = use_cpp),
         wtsne = wtsne(perplexity = perplexity, n_threads = n_threads, eps = eps, use_cpp = use_cpp),
         wssne = wssne(perplexity = perplexity, n_threads = n_threads, eps = eps, use_cpp = use_cpp),
         hssne = hssne(perplexity = perplexity, n_threads = n_threads, eps = eps, use_cpp = use_cpp),
         ee = ee(perplexity = perplexity, n_threads = n_threads, eps = eps, use_cpp = use_cpp),
         nerv = nerv(perplexity = perplexity, n_threads = n_threads, eps = eps, use_cpp = use_cpp),
         snerv = snerv(perplexity = perplexity, n_threads = n_threads, eps = eps, use_cpp = use_cpp),
         jse = jse(perplexity = perplexity, n_threads = n_threads, eps = eps, use_cpp = use_cpp),
         sjse = sjse(perplexity = perplexity, n_threads = n_threads, eps = eps, use_cpp = use_cpp),
         smmds = smmds(n_threads = n_threads, eps = eps, use_cpp = use_cpp),
         sammon = sammon(n_threads = n_threads, eps = eps, use_cpp = use_cpp),
         tasne = tasne(perplexity = perplexity, n_threads = n_threads, eps = eps, use_cpp = use_cpp),
         trmsne = trmsne(perplexity = perplexity, n_threads = n_threads, eps = eps, use_cpp = use_cpp),
         trsrsne = trsrsne(perplexity = perplexity, n_threads = n_threads, eps = eps, use_cpp = use_cpp),
         tmsne = tmsne(perplexity = perplexity, n_threads = n_threads, eps = eps, use_cpp = use_cpp),
         arsrsne = arsrsne(perplexity = perplexity, n_threads = n_threads, eps = eps, use_cpp = use_cpp),
         rsrjse = rsrjse(perplexity = perplexity, n_threads = n_threads, eps = eps, use_cpp = use_cpp),
         rsrnerv = rsrnerv(perplexity = perplexity, n_threads = n_threads, eps = eps, use_cpp = use_cpp),
         btsne = btsne(perplexity = perplexity, n_threads = n_threads, eps = eps, use_cpp = use_cpp),
         bssne = bssne(perplexity = perplexity, n_threads = n_threads, eps = eps, use_cpp = use_cpp),
         basne = basne(perplexity = perplexity, n_threads = n_threads, eps = eps, use_cpp = use_cpp),
         btasne = btasne(perplexity = perplexity, n_threads = n_threads, eps = eps, use_cpp = use_cpp),
         bnerv = bnerv(perplexity = perplexity, n_threads = n_threads, eps = eps, use_cpp = use_cpp),
         ...
         dhssne = dhssne(perplexity = perplexity, n_threads = n_threads, eps = eps, use_cpp = use_cpp),
         tsneu = tsneu(perplexity = perplexity, n_threads = n_threads, eps = eps, use_cpp = use_cpp),
         pstsne = pstsne(perplexity = perplexity, n_threads = n_threads, eps = eps, use_cpp = use_cpp),
         skdtsne = skdtsne(perplexity = perplexity, n_threads = n_threads, eps = eps, use_cpp = use_cpp),
         usne = usne(perplexity = perplexity, n_threads = n_threads, eps = eps, use_cpp = use_cpp),
         cetsne = cetsne(perplexity = perplexity, n_threads = n_threads, eps = eps, use_cpp = use_cpp),
         tee = tee(perplexity = perplexity, n_threads = n_threads, eps = eps, use_cpp = use_cpp),
         absne = absne(perplexity = perplexity, n_threads = n_threads, eps = eps, use_cpp = use_cpp),
         chsne = chsne(perplexity = perplexity, n_threads = n_threads, eps = eps, use_cpp = use_cpp),
         hlsne = hlsne(perplexity = perplexity, n_threads = n_threads, eps = eps, use_cpp = use_cpp),
         gsne = gsne(perplexity = perplexity, n_threads = n_threads, eps = eps, use_cpp = use_cpp),
         rklsne = rklsne(perplexity = perplexity, n_threads = n_threads, eps = eps, use_cpp = use_cpp),
         jssne = jssne(perplexity = perplexity, n_threads = n_threads, eps = eps, use_cpp = use_cpp),      
         abssne = abssne(perplexity = perplexity, n_threads = n_threads, eps = eps, use_cpp = use_cpp),
         bhssne = bhssne(perplexity = perplexity, n_threads = n_threads, eps = eps, use_cpp = use_cpp),
